...
- [Continue.dev](ide/continue.md), VS Code and JetBrains AI assistant
- [aider](ide/aider.md), Terminal-based AI pair programming
- [avante.nvim](ide/avante-nvim.md), Neovim AI plugin
- [Claude Code](ide/claude-code.md), Anthropic's CLI harness
- [Cursor](ide/cursor.md), AI-native code editor
- [Generic OpenAI API](ide/openai-api.md), Any tool that speaks OpenAI

## Operations

- [Model Management](workspace.md), Download, switch, and manage AI models
- [Security Hardening](security.md), Production security best practices
- [Backup & Restore](workspace.md), Protect your data
